...
namespace CleanValidation.Core.Results
{
    ...
    public class InvalidResult<T> : InvalidResult, IResult<T>
    {
        ...
        /// <param name="errors">The entry errors.</param>
        protected InvalidResult(T? value, IEnumerable<Error> errors) : base(errors)
        {
            Value = value;
        }
        ...
        /// <param name="value">The value of type <typeparamref name="T"/>.</param>
        /// <param name="error">The entry error.</param>
        protected InvalidResult(T? value, Error error) : base(error)
        {
            Value = value;
        }
        ...
        public static InvalidResult<T> Create(T? value, IEnumerable<Error> errors)
        {
            return new InvalidResult<T>(value, errors);
        }
        ...
        /// <param name="error">The entry error.</param>
        /// <returns>The <see cref="InvalidResult{T}"/> instance.</returns>
        public static InvalidResult<T> Create(T? value, Error error)
        {
            return new InvalidResult<T>(value, error);
        }
